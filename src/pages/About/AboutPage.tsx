      ...
      <AnimatedOnScroll className="about-container">
        ...
        <div className="content-grid">
          <div className="content-card">
            <img className="content-card-img" src={`${import.meta.env.BASE_URL}Images/About/TwitchLogoBlack_Transparent.png`} />
          ...
          <div className="content-card">
            <img className="content-card-img" src={`${import.meta.env.BASE_URL}Images/About/BlackRLLogo_Transparent.png`} />
          ...
          <div className="content-card">
            <img className="content-card-img" src={`${import.meta.env.BASE_URL}Images/About/BlackValTransparent.png`} />
          ...
          <div className="content-card">
            <img className="content-card-img" src={`${import.meta.env.BASE_URL}Images/About/BlackClock_Transparent.png`} />
